      ...
      return new Promise(function (resolve, reject) {
        jsonwebtoken.verify(
          ...
          function (header, callback) {
            // caching of JWKS
            if (config.cacheJWKSAge && implementation.cache) {
              const signingKey = implementation.cache.get('signingKey')
              if (signingKey) {
            ...
            client.getSigningKey(header.kid, function (err, key) {
              ...
              if (config.cacheJWKSAge && implementation.cache && !implementation.cache.get('signingKey')) {
                implementation.cache.set('signingKey', signingKey, config.cacheJWKSAge)
              }
